...
int main()
{
  ...
  cout << "Press the key 't' to enable the system tracking the object" << endl;
  cout << "Press the key 'esc' to exit the program" << endl;
  cout << "Press the key 'd' or 'e' or 'o' to debug program and test the filters" << endl;
  cout << "Press the key 'p' to pause the program" << endl;
  ...
  while (1)
  {
    ...
    capture.open("../Dataset-Filters/bouncingBall.avi");
